...
void TSTP_MAC_NED::startup()
{
    ...
    OFFSET_GENERAL_LOWER_BOUND = par("offsetGeneralLowerBound").doubleValue();
    OFFSET_LOWER_BOUND = par("offsetLowerBound").doubleValue();
    OFFSET_UPPER_BOUND = SLEEP_PERIOD - CCA_TIME - MICROFRAME_TIME;
    OFFSET_GENERAL_UPPER_BOUND = OFFSET_UPPER_BOUND - par("offsetGeneralUpperBoundReduction").doubleValue();
