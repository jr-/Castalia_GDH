...
struct PktBreakdown {
	...
	/* initialize the struct (C++ syntax) */
	PktBreakdown():transmissions(0), bytesTransmitted(0),
	                RxReachedNoInterference(0),
...
class Radio: public CastaliaModule {
 private:
        ...
        static std::ofstream pcapFile;
        static bool doPcapLog;
	...
	BasicState_type defaultStateAfterTX;
